 ...
 */
package edu.kit.ipd.sdq.kamp.ruledsl.serializer;
...
public class KampRuleLanguageSemanticSequencer extends MirBaseSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == KampRuleLanguagePackage.eINSTANCE)
			switch (semanticObject.eClass().getClassifierID()) {
			case KampRuleLanguagePackage.BACKWARD_EREFERENCE:
				sequence_BackwardEReference_MetaclassReference(context, (BackwardEReference) semanticObject); 
				return; 
			case KampRuleLanguagePackage.FORWARD_EREFERENCE:
				sequence_ForwardEReference(context, (ForwardEReference) semanticObject); 
				return; 
			case KampRuleLanguagePackage.KAMP_RULE:
				sequence_KampRule(context, (KampRule) semanticObject); 
				return; 
			case KampRuleLanguagePackage.RULE_FILE:
				sequence_MirBaseFile_RuleFile(context, (RuleFile) semanticObject); 
				return; 
			}
	...
	/**
	 * Contexts:
	 *     Lookup returns BackwardEReference
	 *     PropagationReference returns BackwardEReference
	 *     BackwardEReference returns BackwardEReference
	 *
	 * Constraint:
	 *     (metamodel=[MetamodelImport|ID]? metaclass=[EClass|QualifiedName] feature=[EStructuralFeature|ValidID])
	 */
	protected void sequence_BackwardEReference_MetaclassReference(ISerializationContext context, BackwardEReference semanticObject) {
	...
	/**
	 * Contexts:
	 *     Lookup returns ForwardEReference
	 *     PropagationReference returns ForwardEReference
	 *     ForwardEReference returns ForwardEReference
	 *
	 * Constraint:
	 *     feature=[EReference|ID]
	 */
	protected void sequence_ForwardEReference(ISerializationContext context, ForwardEReference semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, KampRuleLanguagePackage.Literals.PROPAGATION_REFERENCE__FEATURE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, KampRuleLanguagePackage.Literals.PROPAGATION_REFERENCE__FEATURE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getForwardEReferenceAccess().getFeatureEReferenceIDTerminalRuleCall_1_0_1(), semanticObject.eGet(KampRuleLanguagePackage.Literals.PROPAGATION_REFERENCE__FEATURE, false));
		feeder.finish();
	}
	...
	/**
	 * Contexts:
	 *     KampRule returns KampRule
	 *
	 * Constraint:
	 *     (name=ID source=UnnamedMetaclassReference lookups+=Lookup+)
	 */
	protected void sequence_KampRule(ISerializationContext context, KampRule semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Contexts:
	 *     RuleFile returns RuleFile
	 *
	 * Constraint:
	 *     (metamodelImports+=MetamodelImport* name=ValidID rules+=KampRule+)
	 */
	protected void sequence_MirBaseFile_RuleFile(ISerializationContext context, RuleFile semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
