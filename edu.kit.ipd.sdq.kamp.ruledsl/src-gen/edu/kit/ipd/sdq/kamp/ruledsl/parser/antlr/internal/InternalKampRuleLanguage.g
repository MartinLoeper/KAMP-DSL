...
entryRuleRuleFile returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getRuleFileRule()); }
	iv_ruleRuleFile=ruleRuleFile
	{ $current=$iv_ruleRuleFile.current; }
	EOF;

// Rule RuleFile
ruleRuleFile returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleKampRule returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getKampRuleRule()); }
	iv_ruleKampRule=ruleKampRule
	{ $current=$iv_ruleKampRule.current; }
	EOF;

// Rule KampRule
ruleKampRule returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
@after {
	...
	{
		$current = $this_PropagationReference_0.current;
		afterParserOrEnumRuleCall();
	}
;

// Entry rule entryRulePropagationReference
entryRulePropagationReference returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getPropagationReferenceRule()); }
	iv_rulePropagationReference=rulePropagationReference
	{ $current=$iv_rulePropagationReference.current; }
	EOF;

// Rule PropagationReference
rulePropagationReference returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		...
		{
			$current = $this_ForwardEReference_0.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_BackwardEReference_1.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
entryRuleForwardEReference returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getForwardEReferenceRule()); }
	iv_ruleForwardEReference=ruleForwardEReference
	{ $current=$iv_ruleForwardEReference.current; }
	EOF;

// Rule ForwardEReference
ruleForwardEReference returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleBackwardEReference returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getBackwardEReferenceRule()); }
	iv_ruleBackwardEReference=ruleBackwardEReference
	{ $current=$iv_ruleBackwardEReference.current; }
	EOF;

// Rule BackwardEReference
ruleBackwardEReference returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		...
		{
			$current = $this_MetaclassReference_1.current;
			afterParserOrEnumRuleCall();
		}
		otherlv_2='['
		{
