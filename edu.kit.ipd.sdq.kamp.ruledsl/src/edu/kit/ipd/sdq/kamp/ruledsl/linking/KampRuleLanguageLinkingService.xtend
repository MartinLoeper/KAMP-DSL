 ...
 */
class KampRuleLanguageLinkingService extends DefaultLinkingService {
	private static final Logger log = Logger.getLogger(typeof(KampRuleLanguageLinkingService));
