 ...
 */
package edu.kit.ipd.sdq.kamp.ruledsl.ide.contentassist.antlr;

import com.google.inject.Inject;
import edu.kit.ipd.sdq.kamp.ruledsl.ide.contentassist.antlr.internal.InternalKampRuleLanguageParser;
...
public class KampRuleLanguageParser extends AbstractContentAssistParser {
	...
	@Override
	protected InternalKampRuleLanguageParser createParser() {
		InternalKampRuleLanguageParser result = new InternalKampRuleLanguageParser(null);
	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getPropagationReferenceAccess().getAlternatives(), "rule__PropagationReference__Alternatives");
					...
					put(grammarAccess.getRuleFileAccess().getGroup(), "rule__RuleFile__Group__0");
					put(grammarAccess.getKampRuleAccess().getGroup(), "rule__KampRule__Group__0");
					put(grammarAccess.getForwardEReferenceAccess().getGroup(), "rule__ForwardEReference__Group__0");
					put(grammarAccess.getBackwardEReferenceAccess().getGroup(), "rule__BackwardEReference__Group__0");
					...
					put(grammarAccess.getRuleFileAccess().getNameAssignment_3(), "rule__RuleFile__NameAssignment_3");
					put(grammarAccess.getRuleFileAccess().getRulesAssignment_4(), "rule__RuleFile__RulesAssignment_4");
					put(grammarAccess.getKampRuleAccess().getNameAssignment_1(), "rule__KampRule__NameAssignment_1");
					put(grammarAccess.getKampRuleAccess().getSourceAssignment_3(), "rule__KampRule__SourceAssignment_3");
					put(grammarAccess.getKampRuleAccess().getLookupsAssignment_4(), "rule__KampRule__LookupsAssignment_4");
					put(grammarAccess.getForwardEReferenceAccess().getFeatureAssignment_1(), "rule__ForwardEReference__FeatureAssignment_1");
					put(grammarAccess.getBackwardEReferenceAccess().getFeatureAssignment_3(), "rule__BackwardEReference__FeatureAssignment_3");
